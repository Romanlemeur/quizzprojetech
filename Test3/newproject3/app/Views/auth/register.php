<section class="quizz-du-moment">
    <div class="container register-container">
        <div class="auth-card">
            <h2 class="section-title" style="margin-bottom: 32px;">Inscription</h2>
                ...
                <form action="<?= site_url('register') ?>" method="post">
                    <div class="form-group">
                        ...
                        <?php if (isset($validation) && $validation->hasError('username')): ?>
                            <small class="form-error"><?= $validation->getError('username') ?></small>
                        <?php endif; ?>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <?php if (isset($validation) && $validation->hasError('confirm_password')): ?>
                            <small class="form-error"><?= $validation->getError('confirm_password') ?></small>
                        <?php endif; ?>
                    </div>
                    <div class="d-grid">
