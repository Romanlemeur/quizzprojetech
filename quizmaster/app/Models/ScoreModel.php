...
class ScoreModel extends Model
{
    ...
    protected $allowedFields = ['user_id', 'quiz_id', 'score', 'completed_at', 'is_live', 'current_question'];
    ...
    // Mise à jour de la position dans le quiz
    public function updateCurrentQuestion($user_id, $quiz_id, $questionNumber)
    {
        $where = [
            'user_id' => $user_id,
            'quiz_id' => $quiz_id,
