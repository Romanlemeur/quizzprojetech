            ...
            <table class="leaderboard-table">
                ...
                <tbody>
                    <?php if (empty($leaderboard)): ?>
                        <tr>
                            <td colspan="5" style="text-align: center;">Aucun score disponible. Soyez le premier à participer à un quiz !</td>
                        </tr>
                    <?php else: ?>
                        <?php foreach ($leaderboard as $index => $entry): ?>
                            ...
                            <tr>
                                ...
                                <td><?= htmlspecialchars($entry['quiz_title'] ?? $quiz['title']) ?></td>
                                <td class="user-score"><?= htmlspecialchars($entry['score']) ?></td>
                                <td><?= isset($entry['completed_at']) ? date('d/m/Y', strtotime($entry['completed_at'])) : '-' ?></td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </tbody>
