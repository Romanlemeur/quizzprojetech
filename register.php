...
<div class="auth-container">
  <div class="auth-card">
    <h2 class="auth-header neon-text">Inscription</h2>
    <form method="POST" action="register.php">
      <div class="form-group">
        <label class="form-label" for="username">Nom d'utilisateur</label>
        <input class="form-control" type="text" id="username" name="username" placeholder="Choisissez un nom" required>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        <label class="form-label" for="confirm_password">Confirmez le mot de passe</n        ></label>
